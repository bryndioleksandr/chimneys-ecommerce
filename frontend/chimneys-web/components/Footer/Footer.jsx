    ...
    return (
        <footer className={styles.footer}>
            <div className={styles.footerContainer}>
                ...
                <div className={`${styles.footerSection} ${styles["contacts-section"]}`}>
                    <h4>Контакти</h4>
                ...
                <div className={styles.footerPayment}>
                    ...
                    <div className={styles.paymentIcons}>
                        <div className={styles["payment-icons-grid"]}>
                            ...
                            <img src="/logo_liqpay_for%20black.svg" alt="LiqPay" width="100"/>
                        </div>
                    </div>
                </div>

                <div className={`${styles.footerSection} ${styles["map-section"]}`}>
                    <h4>Знайти нас</h4>
            ...
            <div className={styles.footerBottom}>
                <p className={styles["p-footer-bottom"]}>
                    © {new Date().getFullYear()} ДимоHIT. Всі права захищено.
                    <br className={styles["mobile-break"]}/>
                    Розробка сайту:{" "}
                    <a
                        className={styles["a-footer-bottom"]}
                        href="mailto:s.v.bryndo@gmail.com"
                    >
                        Олександр Бриндьо
                    </a>
                </p>

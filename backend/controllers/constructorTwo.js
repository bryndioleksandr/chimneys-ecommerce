import ConstructorTwo from "../models/constructorTwo.js";
...
export const createConstructor = async (req, res) => {
    try {
        ...
        const constructor = new ConstructorTwo({
            name,
            description,
...
export const updateConstructor = async (req, res) => {
    try {
        ...
        const updated = await ConstructorTwo.findByIdAndUpdate(
            id,
            {
                name,
                description,
...
export const updateConstructorElement = async (req, res) => {
    try {
        ...
        let constructor = await ConstructorTwo.findOne();

        if (!constructor) {
            constructor = new ConstructorTwo();
        ...
        const populated = await ConstructorTwo.findById(constructor._id).populate("products.product");
...
export const getConstructor = async (req, res) => {
    try {
        ...
        const constructor = await ConstructorTwo.findById(id).populate("products.product");
...
export const getConstructorElement = async (req, res) => {
    try {
        ...
        const constructor = await ConstructorTwo.findOne().populate("products.product");
...
export const deleteConstructor = async (req, res) => {
    try {
        ...
        const deleted = await ConstructorTwo.findByIdAndDelete(id);
...
export const deleteConstructorElement = async (req, res) => {
    try {
        ...
        const updated = await ConstructorTwo.findOneAndUpdate(
            {
